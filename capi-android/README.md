...
<div align="center">
  <img src="https://github.com/Jhezdev/Capi/blob/master/fastlane/metadata/android/en-US/images/featureGraphic.png" alt="Banner de Capi" width="100%"/>
  
  ### Cliente Avanzado de YouTube Music con Material Design 3 para Android
  
  [![Última Versión](https://img.shields.io/github/v/release/Jhezdev/Capi?style=flat-square&logo=github&color=0D1117&labelColor=161B22)](https://github.com/Jhezdev/Capi/releases)
  [![Licencia](https://img.shields.io/github/license/Jhezdev/Capi?style=flat-square&logo=gnu&color=2B3137&labelColor=161B22)](https://github.com/Jhezdev/Capi/blob/main/LICENSE)
  [![Estado de Traducción](https://badges.crowdin.net/capi/localized.svg)](https://crowdin.com/project/capi)
  ...
  [![Estrellas](https://img.shields.io/github/stars/Jhezdev/Capi?style=flat-square&logo=github&color=yellow&labelColor=161B22&cacheSeconds=21600)](https://github.com/Jhezdev/Capi/stargazers)
  [![Forks](https://img.shields.io/github/forks/Jhezdev/Capi?style=flat-square&logo=github&color=blue&labelColor=161B22&cacheSeconds=21600)](https://github.com/Jhezdev/Capi/network/members)
</div>
...
> **Nota**: Capi es un proyecto independiente y no está afiliado, patrocinado ni respaldado por YouTube o Google.
...
[![Documentación](https://img.shields.io/badge/Documentación-GitBook-4285F4?style=for-the-badge&logo=gitbook&logoColor=white)](https://capi.gitbook.io/)
...
1. Navega a la sección de [Releases](https://github.com/Jhezdev/Capi/releases) en GitHub
...
1. Visita el [sitio web oficial de Capi](https://capi.netlify.app/)
...
[<img src="https://f-droid.org/badge/get-it-on.png" alt="Get it on F-Droid" height="80">](https://f-droid.org/es/packages/com.Jhezdev.capi)
...
[<img src="https://www.openapk.net/images/openapk-badge.png" alt="Get it on OpenApk" height="80">](https://www.openapk.net/capi/com.Jhezdev.capi/)
...
git clone https://github.com/Jhezdev/Capi.git
...
3. Navega y selecciona el directorio de Capi
...
Todos los participantes en este proyecto deben adherirse a nuestro código de conducta que promueve un entorno inclusivo, respetuoso y constructivo. Por favor, revisa el [Código de Conducta completo](https://github.com/Jhezdev/Capi/blob/master/CODE_OF_CONDUCT.md) antes de contribuir.

### Traducción

Ayuda a traducir Capi a tu idioma o mejorar las traducciones existentes:
...
[![Crowdin](https://img.shields.io/badge/Crowdin-2E3440?style=for-the-badge&logo=crowdin&logoColor=white)](https://crowdin.com/project/capi)
...
[![Chat de Telegram](https://img.shields.io/badge/Telegram-Chat-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/Capi_chat)
[![Actualizaciones de Telegram](https://img.shields.io/badge/Telegram-Actualizaciones-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/capi_updates)

</div>

### Flujo de Trabajo de Desarrollo

1. **Revisión de Issues**: Verifica [issues abiertas](https://github.com/Jhezdev/Capi/issues) o crea una nueva describiendo el problema o característica
...
> **Directrices de Desarrollo**: Revisa nuestras [directrices de contribución](https://github.com/Jhezdev/Capi/blob/master/CONTRIBUTING.md) para información detallada sobre el proceso de desarrollo, estándares de código y flujo de trabajo.

---

## Apoya el Proyecto

Si encuentras valor en **Capi** y quieres contribuir a su desarrollo continuo, considera hacer una donación. Tu apoyo financiero nos permite:
...
[![GitHub Sponsors](https://img.shields.io/badge/GitHub_Sponsors-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/sponsors/Jhezdev)
[![PayPal](https://img.shields.io/badge/PayPal-00457C?style=for-the-badge&logo=paypal&logoColor=white)](mailto:jhezdev@gmail.com)

</div>

> **Nota**: Las donaciones son completamente opcionales. Capi siempre será gratuito y de código abierto, independientemente del apoyo financiero recibido.

---

## 🌟 Reconocimientos

Capi existe gracias al trabajo, inspiración y apoyo de numerosos proyectos y personas dentro de la comunidad de desarrollo de aplicaciones musicales open source.

Agradecemos especialmente a:

---

### 💡 Proyectos que inspiraron Capi

- **[ArchiveTune](https://github.com/koiverse/ArchiveTune)**  
  Proyecto base e inspiración inicial para muchas de las ideas y funcionalidades que dieron forma a Capi.
...
- **Traductores de la comunidad**  
  Gracias a todos los colaboradores que ayudan a mantener Capi disponible en múltiples idiomas y permiten que usuarios de todo el mundo puedan disfrutar de la aplicación.
...
Capi también reconoce el trabajo de todos los desarrolladores que crean herramientas, librerías y proyectos de código abierto que hacen posible construir aplicaciones modernas para Android.
...
Este programa se distribuye con la esperanza de que sea útil, pero **SIN NINGUNA GARANTÍA**; ni siquiera la garantía implícita de COMERCIABILIDAD o IDONEIDAD PARA UN PROPÓSITO PARTICULAR. Consulta la [Licencia Pública General GNU](https://github.com/Jhezdev/Capi/blob/main/LICENSE) para más detalles.
...
<div align="center">
  ...
  <p>Desarrollado con pasión por <a href="https://github.com/Jhezdev">Jesus Herrera</a></p>
  
  <br>
  
  [![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Jhezdev)
  [![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:jhezdev@gmail.com)
