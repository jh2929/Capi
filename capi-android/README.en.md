...
<div align="center">
  <img src="https://github.com/Jhezdev/Capi/blob/master/fastlane/metadata/android/en-US/images/featureGraphic.png" alt="Capi Banner" width="100%"/>
  
  ### Advanced YouTube Music Client with Material Design 3 for Android
  
  [![Latest Release](https://img.shields.io/github/v/release/Jhezdev/Capi?style=flat-square&logo=github&color=0D1117&labelColor=161B22)](https://github.com/Jhezdev/Capi/releases)
  [![License](https://img.shields.io/github/license/Jhezdev/Capi?style=flat-square&logo=gnu&color=2B3137&labelColor=161B22)](https://github.com/Jhezdev/Capi/blob/main/LICENSE)
  [![Translation Status](https://badges.crowdin.net/capi/localized.svg)](https://crowdin.com/project/capi)
  ...
  [![Stars](https://img.shields.io/github/stars/Jhezdev/Capi?style=flat-square&logo=github&color=yellow&labelColor=161B22&cacheSeconds=21600)](https://github.com/Jhezdev/Capi/stargazers)
...
> **Note**: Capi is an independent project and is not affiliated, sponsored, or endorsed by YouTube or Google.
...
[![Documentation](https://img.shields.io/badge/Documentation-GitBook-4285F4?style=for-the-badge&logo=gitbook&logoColor=white)](https://capi.gitbook.io/)
...
1. Navigate to the [Releases](https://github.com/Jhezdev/Capi/releases) section on GitHub
...
1. Visit the official [Capi website](https://capi.netlify.app/)
...
3. Navigate and select the Capi directory
...
All participants in this project must adhere to our code of conduct that promotes an inclusive, respectful, and constructive environment. Please review the [complete Code of Conduct](https://github.com/Jhezdev/Capi/blob/master/CODE_OF_CONDUCT.md) before contributing.

### Translation

Help translate Capi into your language or improve existing translations:
...
[![Telegram Chat](https://img.shields.io/badge/Telegram-Chat-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/Capi_chat)
[![Telegram Updates](https://img.shields.io/badge/Telegram-Updates-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/capi_updates)

</div>

### Development Workflow

1. **Issue Review**: Check [open issues](https://github.com/Jhezdev/Capi/issues) or create a new one describing the problem or feature
...
> **Development Guidelines**: Review our [contribution guidelines](https://github.com/Jhezdev/Capi/blob/master/CONTRIBUTING.md) for detailed information about development process, code standards, and workflow.

---

## Support the Project

If you find value in **Capi** and want to contribute to its continued development, consider making a donation. Your financial support allows us to:
...
> **Note**: Donations are completely optional. Capi will always be free and open-source, regardless of financial support received.
...
- **Community translators** - Making Capi accessible worldwide
...
This program is distributed in the hope that it will be useful, but **WITHOUT ANY WARRANTY**; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the [GNU General Public License](https://github.com/Jhezdev/Capi/blob/main/LICENSE) for more details.
...
<div align="center">
  ...
  <p>Developed with passion by <a href="https://github.com/Jhezdev">Jesus Herrera</a></p>
