...
-keep class com.jhezdev.capi.models.PersistQueue { *; }
-keep class com.jhezdev.capi.models.PersistPlayerState { *; }
-keep class com.jhezdev.capi.models.QueueData { *; }
-keep class com.jhezdev.capi.models.QueueType { *; }
-keep class com.jhezdev.capi.playback.queues.** { *; }
