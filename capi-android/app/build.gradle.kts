...
fun fetchGitCommitHash(): String {
    ...
    return try {
        ...
        val url = URL("https://api.github.com/repos/Jhezdev/Capi/commits/master")
...
android {
    namespace = "com.jhezdev.capi"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.jhezdev.capi"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "1.0.0"
//        versionName = "3.0.2-$gitCommit"
    ...
    signingConfigs {
        create("release") {
            storeFile = file("capi-release.jks")
            storePassword = "capiopen2026"
            keyAlias = "capi-key"
            keyPassword = "capiopen2026"
        }
    }
