...
import com.jhezdev.capi.constants.MaxImageCacheSizeKey
...
import com.jhezdev.capi.extensions.tryOrNull
import com.jhezdev.capi.ui.component.ActionPromptDialog
...
import com.jhezdev.capi.ui.player.CanvasArtworkPlaybackCache
import com.jhezdev.capi.ui.utils.backToMain
import com.jhezdev.capi.ui.utils.formatFileSize
    ...
    LaunchedEffect(maxImageCacheSize) {
        if (maxImageCacheSize == 0) {
            coroutineScope.launch(Dispatchers.IO) {
                ...
                com.jhezdev.capi.utils.ArtworkStorage.clear(context)
            }
        }
    }
