...
import com.jhezdev.capi.ui.component.LyricsBackgroundType
import com.jhezdev.capi.ui.component.LyricsCardConfig
import com.jhezdev.capi.ui.component.LyricsGlassStyle
import com.jhezdev.capi.ui.component.LyricsLayoutStyle
...
object ComposeToImage {
    ...
    // ─────────────────────────────────────────────────────────────────────────
    // Helper: branding Capi (igual al original)
    // ─────────────────────────────────────────────────────────────────────────
    ...
    private fun drawBranding(
        ...
        val rawLogo   = context.getDrawable(R.drawable.capi)?.toBitmap(logoSize, logoSize)
    ...
    fun saveBitmapAsFile(context: Context, bitmap: Bitmap, fileName: String): Uri {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues = ContentValues().apply {
                ...
                put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/Capi")
            }
