...
import com.jhezdev.capi.constants.QueueEditLockKey
...
import com.jhezdev.capi.extensions.toggleRepeatMode
...
import com.jhezdev.capi.ui.component.MediaMetadataListItem
import com.jhezdev.capi.ui.menu.PlayerMenu
import com.jhezdev.capi.ui.menu.SelectionMediaMetadataMenu
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.jhezdev.capi.together.TogetherSessionState.Joined &&
                (togetherSessionState as com.jhezdev.capi.together.TogetherSessionState.Joined).role is com.jhezdev.capi.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.jhezdev.capi.together.TogetherSessionState.Joined
                                                                val isGuest =
                                                                    joined?.role is com.jhezdev.capi.together.TogetherRole.Guest
                                                                if (isGuest) {
