...
class DiscordRPC(
    ...
    companion object {
        ...
        private const val APP_ICON_URL = 
            "https://raw.githubusercontent.com/Jhezdev/Capi/refs/heads/master/assets/icon.png"
    ...
    suspend fun updateSong(
        ...
        val button2Label = context.dataStore[DiscordActivityButton2LabelKey] ?: "Go to Capi"
        ...
        val button2CustomUrl = context.dataStore[DiscordActivityButton2CustomUrlKey] ?: "https://github.com/Jhezdev/Capi"
    ...
    suspend fun refreshActivity(song: Song, currentPlaybackTimeMillis: Long, isPaused: Boolean = false) = runCatching {
        try {
            ...
            com.jhezdev.capi.utils.GlobalLog.append(
