...
import com.jhezdev.capi.widget.PlayerWidgetActions.openAppIntent
...
class CapiPlayerWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(
        ...
        provideContent {
            ...
            GlanceTheme(colors = CapiWidgetColors) {
...
private fun PlayerWidgetContent(state: PlayerWidgetState, uiPrefs: WidgetUiPrefs) {
    ...
    val artist = state.artist.ifBlank { "Capi" }
