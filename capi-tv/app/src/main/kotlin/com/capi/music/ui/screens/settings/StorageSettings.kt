...
import com.capi.music.constants.MaxImageCacheSizeKey
...
import com.capi.music.extensions.tryOrNull
import com.capi.music.ui.component.ActionPromptDialog
...
import com.capi.music.ui.player.CanvasArtworkPlaybackCache
import com.capi.music.ui.utils.backToMain
import com.capi.music.ui.utils.formatFileSize
    ...
    LaunchedEffect(maxImageCacheSize) {
        if (maxImageCacheSize == 0) {
            coroutineScope.launch(Dispatchers.IO) {
                ...
                com.capi.music.utils.ArtworkStorage.clear(context)
            }
        }
    }
