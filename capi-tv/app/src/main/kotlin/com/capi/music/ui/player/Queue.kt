...
import com.capi.music.constants.QueueEditLockKey
...
import com.capi.music.extensions.toggleRepeatMode
...
import com.capi.music.ui.component.MediaMetadataListItem
import com.capi.music.ui.menu.PlayerMenu
import com.capi.music.ui.menu.SelectionMediaMetadataMenu
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.capi.music.together.TogetherSessionState.Joined &&
                (togetherSessionState as com.capi.music.together.TogetherSessionState.Joined).role is com.capi.music.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.capi.music.together.TogetherSessionState.Joined
                                                                val isGuest =
                                                                    joined?.role is com.capi.music.together.TogetherRole.Guest
                                                                if (isGuest) {
