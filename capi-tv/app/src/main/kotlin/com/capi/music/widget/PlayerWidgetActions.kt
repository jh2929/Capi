...
object PlayerWidgetActions {
    const val ACTION_PLAY_PAUSE = "com.capi.music.widget.action.PLAY_PAUSE"
    const val ACTION_NEXT = "com.capi.music.widget.action.NEXT"
    const val ACTION_PREVIOUS = "com.capi.music.widget.action.PREVIOUS"
    const val ACTION_REFRESH = "com.capi.music.widget.action.REFRESH"
