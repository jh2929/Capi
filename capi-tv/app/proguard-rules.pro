...
-keep class com.capi.music.models.PersistQueue { *; }
-keep class com.capi.music.models.PersistPlayerState { *; }
-keep class com.capi.music.models.QueueData { *; }
-keep class com.capi.music.models.QueueType { *; }
-keep class com.capi.music.playback.queues.** { *; }
